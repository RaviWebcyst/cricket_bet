...
class RateController extends Controller
{
    ...
    public function game(Request $request){
        ...
        $balance = $credit-$debit;
        return response()->json(compact('rate','balance','team_a','team_b','wallet_credit_a','wallet_debit_a','wallet_credit_b','wallet_debit_b','wallet_balance_b','wallet_balance_a'));
    ...
    public function match(){
        ...
        return response()->json(compact('matchs'));
    }
